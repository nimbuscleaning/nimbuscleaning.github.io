...
function fullscreenFix(){var t=$("body").height();$(".content-b").each(function(a){$(this).innerHeight()<=t&&$(this).closest(".fullscreen").addClass("not-overflow")})}function backgroundResize(){var t=$(window).height();$(".landing, .action, .contact, .subscribe").each(function(a){var o=$(this),e=o.width(),i=o.height(),n=o.attr("data-img-width"),s=o.attr("data-img-height"),l=n/s,c=parseFloat(o.attr("data-diff"));c=c||0;var r=0;if(o.hasClass("parallax")&&!$("html").hasClass("touch")){r=t-i}e>(n=(s=i+r+c)*l)&&(s=(n=e)/l),o.data("resized-imgW",n),o.data("resized-imgH",s),o.css("background-size",n+"px "+s+"px")})}function parallaxPosition(t){var a=$(window).height(),o=$(window).scrollTop(),e=o+a,i=(o+e)/2;$(".parallax").each(function(t){var n=$(this),s=n.height(),l=n.offset().top,c=l+s;if(e>l&&o<c){n.data("resized-imgW");var r=n.data("resized-imgH"),d=-r+a,h=s<a?r-s:r-a,u=0+(d-0)*(i-(l-=h))/((c+=h)-l),f=n.attr("data-oriz-pos");f=f||"50%",$(this).css("background-position",f+" "+u+"px")}})}$(function(){$("a[href*=#]:not([href=#])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")||location.hostname==this.hostname){var t=$(this.hash);if((t=t.length?t:$("[name="+this.hash.slice(1)+"]")).length)return $("html,body").animate({scrollTop:t.offset().top},1e3),!1}})}),$("body").scrollspy({target:"#navbar-scroll"}),$(".navbar-collapse ul li a").click(function(){$(".navbar-toggle:visible").click()}),$(document).ready(function(){$("#screenshots").owlCarousel({items:4,itemsCustom:[[0,1],[480,2],[768,3],[992,4]]}),$("#owl-testi").owlCarousel({navigation:!1,slideSpeed:300,autoHeight:!0,singleItem:!0})}),$(document).ready(function(){$("#menu").sticky({topSpacing:0})}),jQuery(document).ready(function(t){t(window).load(function(){t("#preloader").fadeOut("slow",function(){t(this).remove()})})}),$(document).ready(function(){$(window).scroll(function(){$(this).scrollTop()>500?$(".scrollToTop").fadeIn():$(".scrollToTop").fadeOut()}),$(".scrollToTop").click(function(){return $("html, body").animate({scrollTop:0},800),!1})}),"ontouchstart"in window&&(document.documentElement.className=document.documentElement.className+" touch"),$("html").hasClass("touch")||$(".parallax").css("background-attachment","fixed"),$(window).resize(fullscreenFix),fullscreenFix(),$(window).resize(backgroundResize),$(window).focus(backgroundResize),backgroundResize(),$("html").hasClass("touch")||($(window).resize(parallaxPosition),$(window).scroll(parallaxPosition),parallaxPosition());
